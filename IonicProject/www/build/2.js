...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__configuracion_contenido__ = __webpack_require__(790);
...
ConfiguracionContenidoPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__configuracion_contenido__["a" /* ConfiguracionContenidoPage */]),
        ],
    })
...
var ConfiguracionContenidoPage = (function () {
    function ConfiguracionContenidoPage(navCtrl, navParams, servicio) {
    ...
    ConfiguracionContenidoPage.prototype.guardarConfig = function () {
        ...
        this.servicio.m12prueba().then(function (result) {
            console.log(result);
        }, function (err) {
            console.log(err);
        });
