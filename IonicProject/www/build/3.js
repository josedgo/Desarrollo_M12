...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mis_videos__ = __webpack_require__(803);
...
MisVideosPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__mis_videos__["a" /* MisVideosPage */]),
        ],
    })
], MisVideosPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_common_http__ = __webpack_require__(397);
...
var MisVideosPage = (function () {
    ...
    */
    ...
    MisVideosPage.prototype.updateImagen = function () {
        ...
        this.http.post("http://192.168.1.116:8080/viucab/Video", JSON.stringify(data)).subscribe(function (data) {
            console.log(JSON.stringify(data.json()));
            _this.presentToast(JSON.stringify(data.json()));
        }, function (error) {
            console.log(JSON.stringify(error.json()));
            _this.presentToast(JSON.stringify(error.json()));
        });
    };
